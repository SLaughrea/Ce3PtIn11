...
"""
filenames = ["005136.txt","005137.txt","005138.txt","005139.txt","005140.txt","005141.txt","005142.txt"]
for filename in filenames:    
    ...
    alpha = 0.95761 # variable based on run
    total_asymmetry = 0.0592 # variable based on run
    ...
    ndim = len(labels)
    # range estimations
    a1min=0.;a1max=0.0592;a1range=a1max-a1min
    #a2min=0.;a2max=0.09;a2range=a2max-a2min
    aBmin=0.1724;aBmax=0.17242;aBrange=aBmax-aBmin
    ...
    sgmin =0.0;sgmax =0.2 ;sgrange=sgmax-sgmin
    ...
    sresults_internBsl = samplerDyn_internFld.results
