...
def log_prior(vector):
    ...
    if (amin < total_asymmetry < amax and fmin < field < fmax and pmin < phi < pmax and smin < sigma < smax):
...
# see 20220420c_Ce3PtIn11_Bayesian_Analysis.py for example of analysis on run 005808.txt (GaAs + sample)
ndim = 4 # vector a 4 composantes

# range estimations

amin=0.20;amax=0.25;arange=amax-amin
fmin=15  ;fmax=25  ;frange=fmax-fmin
pmin=0   ;pmax=5 ;prange=pmax-pmin
smin=0   ;smax=0.1 ;srange=smax-smin
...
convergence_internFld_internBsl(run="005816.txt",temperature = runParam[5][13:18])
