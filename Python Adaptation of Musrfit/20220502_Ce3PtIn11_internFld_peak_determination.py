#%%
"""
Bayesian Analysis of 005816.txt by Sébastien Laughrea
"""
...
def model(vector):
    ...
    internBsl_signal1 = (beta1*cosFunction1*np.exp(-lambdaT1*binT)+(1-beta1)*np.exp(-lambdaL*binT))
    internBsl_signal2 = (beta2*cosFunction2*np.exp(-lambdaT2*binT)+(1-beta2)*np.exp(-lambdaL*binT))
