...
def model(vector):
        asy1, asy3, amp1, amp2, phi1, phi2, field1, field2, lambdaL, lambdaT1, lambdaT2, delta  = vector
        

        asy2 = asy_total - asy3 - asy1
...
labels = ["signal_1_asymmetry","signal_3_asymmetry","fraction_1","fraction_2","phase_1","phase_2","field_1","field_2","lambdaL","lambdaT_1","lambdaT_2","delta"]
ndim = len(labels)
# range estimations
varMin = [0,0,0,0,0,0,100,0,0,0,0,0]
varMax = [0.089,0.089,1,1,360,360,150,20,5,5,5,5]
